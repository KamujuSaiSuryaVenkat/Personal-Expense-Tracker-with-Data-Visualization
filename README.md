...
- Drop critical fields (Amount)
- Fill text fields with defaults
- Investigate and log all changes

**Q2: Explain your database design**
A: We use normalized SQLite tables:
- `expenses`: Main transaction data
- `category_summary`: Aggregated by category
- `monthly_summary`: Aggregated by month

**Q3: How would you optimize for large datasets?**
A: 
- Add database indexes on Date and Category
...
**Q5: What's the architecture of your system?**
A: Clean modular design:
- Separate concerns (loading, cleaning, analysis)
...
- [ ] Review the code and understand each module
